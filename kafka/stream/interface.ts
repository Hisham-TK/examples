...
//     chainReduce(
//       eff: (val: any, ret: any) => any,
//       initial: any,
//       callback: (error: Error, value: any) => void
//     ): StreamDSL;
//     drain(): Promise<void>;
...
//     to(
//       topic?: string,
//       outputPartitionsCount?: number | "auto",
//       produceType?: "send" | "buffer" | "bufferFormat",
//       version?: number,
//       compressionType?: number,
//       producerErrorCallback?: (error: Error) => void,
...
//     );
//     start(
//       kafkaReadyCallback?: () => void,
//       kafkaErrorCallback?: (error: Error) => void,
...
//       from: number,
//       to: number,
//       etl?: null | ((message: any) => any),
//       encapsulated?: boolean
//     ): { window: Window; abort: () => void; stream: KStream };
...
//     constructor(
//       topicName: string,
//       keyMapETL: (message: any) => { key: any; value: any },
//       storage?: KStorage,
//       kafka?: KafkaClient,
//       isClone?: boolean
//     );
